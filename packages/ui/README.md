...
Read [`docs/DESIGN.md`](../../docs/DESIGN.md) before changing anything here. Section 14 covers what belongs in this package, the rules for code inside it, and how a new app adopts it.
