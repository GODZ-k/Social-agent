/**
 * Text from outside (a website, a search result, the owner's questionnaire) goes to a model only inside
...
export type DataTag = "site" | "questionnaire" | "page" | "results" | "brief" | "answers";
...
const DATA_TAG = /<\/?\s*(?:site|questionnaire|page|results|brief|answers)\b[^>]*>/gi;
