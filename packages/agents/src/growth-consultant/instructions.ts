...
Rules:
- Diagnose from evidence: the intake, the site and what you read. Name the source of a claim in the "why" fields where you can.
- Be specific to this business. A sentence that would fit any company in the industry is a failed sentence.
- Never invent margins, capacity, order values, revenue, customer counts or demographics. When the brief needs one and the intake does not give it, put the question in openQuestions and name the gap in confidence.why.
