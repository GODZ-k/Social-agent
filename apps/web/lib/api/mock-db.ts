/**
 * In-memory stand-in for the real API. Everything here is seeded and
 * deterministic, with dates generated relative to "now" so the calendar and
 * charts are always populated. Only `lib/api/client.ts` may import this file.
 */
