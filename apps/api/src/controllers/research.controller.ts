...
export class ResearchController {
    ...
    static async start(req: Request, res: Response) {
        const { research, created } = await ResearchService.start(currentUser(req), brandIdParam(req));
    ...
    static async get(req: Request, res: Response) {
        const data = await ResearchService.get(currentUser(req), brandIdParam(req));
