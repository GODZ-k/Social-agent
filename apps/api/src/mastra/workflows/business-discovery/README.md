...
|---|---|---|
| `gather` | code | Check the brand kit, the intake answers, the site facts and any previous research. The database reads happen in `run.ts` before the workflow starts, so no step touches a repository. |
